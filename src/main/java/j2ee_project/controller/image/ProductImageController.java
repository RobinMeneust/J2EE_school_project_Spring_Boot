...
public class ProductImageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        Path imagePath = Paths.get("src/main/resources/static/img/", product.getImagePath());
...
//        String productName = productService.getProduct(productId).getName().replaceAll("s/[\\\\/]/g",""); // We remove backslashes and slashes to protect us from path traversal
//        extension = extension.replaceAll("[\\\\/]","");
//        productService.setProductImagePath(productId,"products/"+productName+"_"+productId+"."+extension);
//
//        File root = new File(getServletContext().getRealPath("/")).getParentFile().getParentFile();
//        Path uploadImagePath = Paths.get(root.getPath()+"/images/"+productService.getProduct(productId).getImagePath());
//
//
//
